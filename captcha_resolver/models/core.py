# This function is used to resolver captcha, it will load models from models/*.onnx
# In the meantime, it will be called from captcha_resolver/__init__.py
...
class Resolver:
    def __init__(self, ocr: bool = True, det: bool = False, old: bool = False, beta: bool = False, use_gpu: bool = False,
        ...
        if import_onnx_path != "":
            ...
            with open(charsets_path, encoding="utf-8") as f:
